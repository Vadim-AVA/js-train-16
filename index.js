...
filteredStudents.forEach(student => {
  console.log(`${student.name} отримав оцінку ${grade}`);
});
...
function compareArrays(arr1, arr2) {
  ...
  console.assert(isEqual, "Масиви не є однаковими");
}
...
function traceBackward(n) {
  ...
  console.log("Поточне число n: " + n);
  if (n > 1) {
    traceBackward(n - 1);
  } else {
    console.trace("Стек викликів при досягненні 1");
  }
...
// Створення змінної total, яка буде нашою загальною ціною; початкове значення - 0
let total = 0;
